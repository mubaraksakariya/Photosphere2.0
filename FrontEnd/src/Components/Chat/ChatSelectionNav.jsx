...
function ChatSelectionNav({ searchQuery, handleSearch }) {
	return (
		<div className='flex flex-col max-h-[93%] md:max-h-full h-full bg-lightMode-section dark:bg-darkMode-section p-4 border-r border-lightMode-shadow dark:border-darkMode-shadow w-full'>
